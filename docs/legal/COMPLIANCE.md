...
| **DBE NSC downloads** | Public exam site ≠ redistribution licence for AssessMate; keep local; clearance before bank/AI ingest | `parent-samples/dbe-nsc/MANIFEST.md` |
| **IEB NSC downloads** | Same stance as DBE — local reference only; clearance before ingest/redistribution | `parent-samples/ieb-nsc/MANIFEST.md` |
...
| DBE NSC past-paper reuse (layout vs verbatim bank) | Legal + PO | Open — local reference OK; clearance before product ingest/redistribution. **Enquire:** DBE Matric Exams Revision webmaster **012 357 3762 / 3752 / 3799** (see `parent-samples/dbe-nsc/MANIFEST.md`) |
| IEB NSC past-paper reuse (layout vs verbatim bank) | Legal + PO | Open — local dump under `ieb-nsc/`; confirm IEB licence before ingest/redistribution |
